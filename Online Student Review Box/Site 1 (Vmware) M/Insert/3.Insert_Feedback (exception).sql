...
BEGIN
	...
	IF row_no >0 THEN 
	  InsertSite1.Insert_Feedback(feedback_std_roll,feedback_std_class,UPPER(feedback_std_sec),UPPER(feedback_emp_id),INITCAP(feedback_std_branch),feedback_review);
    ELSE
